...
BUCKETNAME = 'recserve_' + PROJECT_ID
...
t2 = GoogleCloudStorageToGoogleCloudStorageOperator(
    task_id='copy_files',
    source_bucket='mse-data',
    source_object='ml-data/MSE_OAE_Cat_ML.csv',
    destination_bucket=BUCKETNAME,
    dag=dag
)

# ML Engine training job
training_file = BUCKET + '/ml-data/MSE_OAE_Cat_ML.csv'
